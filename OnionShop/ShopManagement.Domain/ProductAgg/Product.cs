...
namespace ShopManagement.Domain.ProductAgg
{
    public class Product : EntityBase
    {
        ...
        public void Edit(string name, string code, double unitPrice, string description, string shortDescription, string picture, string pictureAlt, string pictureTitle, string slug, string keywords, string metaDescription, long categoryId)
        {
            Name = name;
            Code = code;
            UnitPrice = unitPrice;
