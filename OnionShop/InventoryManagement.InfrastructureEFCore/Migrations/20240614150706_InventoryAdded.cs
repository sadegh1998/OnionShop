    ...
    public partial class InventoryAdded : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InventoryOperattions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InventoryOperattions_Inventories_InventoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryOperattions_InventoryId",
                table: "InventoryOperattions",
                column: "InventoryId");
        }
